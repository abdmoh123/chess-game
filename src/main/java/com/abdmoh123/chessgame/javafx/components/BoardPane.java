...
public class BoardPane extends GridPane {
    ...
    public SpacePane getCell(int column, int row) {
        /*
         * Return cell based on inputted columns and rows (similar to Space
         * class/Board.getPiece method)
         */

        // gridpane stores cells in format (row, column) instead of (column, row) like
        // the Space class
    ...
    public void updateCell(Space coordinate, Piece piece_in) {
        ...
        if (piece_in == null)
            ...
            piece_symbol = piece_in.getSymbol();
